  ...
  <html>
	...
	<style type="text/css"><![CDATA[
		* { box-sizing: border-box; }
		...
		table#contents { width: 90%; margin-left: auto; margin-right: auto; border-collapse: collapse; border-width: 0px; }
	      ...
	      <table id="contents">
	        <tbody>
			  ...
			  <xsl:for-each select="file">
				<xsl:if test=".='111AAA_gallery.php'">
				  <tr class="directory go-up">
	                <td class="icon"><a href="111AAA_gallery.php"><i class="fa fa-address-card"></i></a></td>
	                <td class="name"><a href="111AAA_gallery.php" style="color: #BF8EF3 !important;">Gallery</a></td>
	                <td class="size"><a href="111AAA_gallery.php"></a></td>
	                <td class="mtime"><a href="111AAA_gallery.php"></a></td>
                    <td class="actions"><a href="111AAA_gallery.php"></a></td>
	              </tr>
				</xsl:if>
			  </xsl:for-each>
			  
			  <xsl:for-each select="file">
				<xsl:if test=".='111AAA_tags.html'">
				  <tr class="directory go-up">
	                <td class="icon"><a href="111AAA_tags.html"><i class="fa fa-tags"></i></a></td>
	                <td class="name"><a href="111AAA_tags.html" style="color: #BF8EF3 !important;">Tags</a></td>
	                <td class="size"><a href="111AAA_tags.html"></a></td>
	                <td class="mtime"><a href="111AAA_tags.html"></a></td>
                    <td class="actions"><a href="111AAA_tags.html"></a></td>
	              </tr>
				</xsl:if>
			  </xsl:for-each>
	          ...
	          <xsl:for-each select="file[.!='111AAA_gallery.php']">
			    <xsl:if test=".!='111AAA_tags.html'">
	            <tr class="file">
